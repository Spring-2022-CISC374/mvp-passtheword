...
export class EndScene extends Phaser.Scene { //File created by Braxton
    ...
    create() {
        ...
        this.turnCountText['Turn Count'] = this.add.text(size.x/2, 100,"You guessed the password in " + players.activePlayer.turn + " turn(s)!",textHandler.mediumText).setOrigin();
